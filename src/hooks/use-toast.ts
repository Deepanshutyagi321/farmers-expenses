...
// Define the Action type using the ActionType
type Action =
  | {
      type: "ADD_TOAST"
      toast: ToasterToast
...
// Reducer function for managing toasts
export const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    default:
      return state // Add a default case to handle unknown actions
  }
}
